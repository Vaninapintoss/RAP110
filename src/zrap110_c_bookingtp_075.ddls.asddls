...
define view entity ZRAP110_C_BOOKINGTP_075
  as projection on ZRAP110_R_BOOKINGTP_075
{
  ...
  key     BookingID,
          ...
          _BookingStatus._Text.Text as BookingStatusText : localized, //element added
                    ...
                    @ObjectModel.virtualElementCalculatedBy: 'ABAP:ZRAP110_CALC_BOOK_ELEM_075'
          ...
          // public associations
          _Travel : redirected to parent ZRAP110_C_TRAVELTP_075,
          _Customer,
          _Carrier,
          _Connection,
          _Flight,
