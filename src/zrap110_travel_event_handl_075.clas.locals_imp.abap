...
CLASS lhe_travel IMPLEMENTATION.
  ...
  METHOD on_travel_accepted.
    ...
    LOOP AT accepted REFERENCE INTO DATA(lr_accepted).
      DATA lr_travel_accepted TYPE zrap110_etrav075.
      ...
      "insert to db
      INSERT zrap110_etrav075 FROM @lr_travel_accepted.
    ENDLOOP.
  ...
  METHOD on_travel_rejected.
    ...
    LOOP AT rejected REFERENCE INTO DATA(lr_rejected).
      DATA lr_travel_rejected TYPE zrap110_etrav075.
      ...
      "insert to db
      INSERT zrap110_etrav075 FROM @lr_travel_rejected.
    ENDLOOP.
  ENDMETHOD.
