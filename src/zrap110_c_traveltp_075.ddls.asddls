...
define root view entity ZRAP110_C_TRAVELTP_075
  provider contract transactional_query
  as projection on ZRAP110_R_TRAVELTP_075
{
  ...
  key     TravelID,
          ...
          _OverallStatus._Text.Text as OverallStatusText : localized, //element added
                    ...
                    @ObjectModel.virtualElementCalculatedBy: 'ABAP:ZRAP110_CALC_TRAV_ELEM_075'
          ...
          // public associations
          _Booking : redirected to composition child ZRAP110_C_BOOKINGTP_075,
          _Agency,
          _Customer,
          _OverallStatus,
          _Currency
