CLASS zrap110_calc_book_elem_075 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS:
      calculate_days_to_flight
        IMPORTING is_original_data TYPE ZRAP110_C_BookingTP_075
        RETURNING VALUE(result)    TYPE ZRAP110_C_BookingTP_075.

  PROTECTED SECTION.
  PRIVATE SECTION.
ENDCLASS.

CLASS zrap110_calc_book_elem_075 IMPLEMENTATION.
    ...
    LOOP AT it_requested_calc_elements ASSIGNING FIELD-SYMBOL(<fs_req_calc_elements>).
      CASE <fs_req_calc_elements>.
        ...
        WHEN 'INITIALDAYSTOFLIGHT'   OR 'REMAININGDAYSTOFLIGHT'
          ...
          DATA lt_book_original_data TYPE STANDARD TABLE OF ZRAP110_C_BookingTP_075 WITH DEFAULT KEY.
          ...
          LOOP AT lt_book_original_data ASSIGNING FIELD-SYMBOL(<fs_book_original_data>).
            ...
            <fs_book_original_data> = zrap110_calc_book_elem_075=>calculate_days_to_flight( <fs_book_original_data> ).
  ...
  METHOD if_sadl_exit_calc_element_read~get_calculation_info.
    IF iv_entity EQ 'ZRAP110_C_BOOKINGTP_075'. "Booking BO node
