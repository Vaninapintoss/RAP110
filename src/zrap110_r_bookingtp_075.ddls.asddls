...
@ObjectModel.sapObjectNodeType.name: 'ZRAP110_Booking_075'
define view entity ZRAP110_R_BOOKINGTP_075
  as select from ZRAP110_ABOOK075 as Booking
  association to parent ZRAP110_R_TRAVELTP_075 as _Travel on $projection.TravelID = _Travel.TravelID
